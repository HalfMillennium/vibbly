        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <ModeToggle />
              <Button asChild className="bg-primary hover:bg-primary/90 text-white rounded-2xl px-6 py-2 glass-button">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="glass-card p-12 mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-white px-8 py-4 rounded-2xl text-lg w-full sm:w-auto glass-button border-0 soft-shadow">
                <Link to="/create">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-8 text-center">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-lg">Instant Preview</h3>
              <p className="text-gray-700 dark:text-gray-200">Preview your clips before creating to ensure perfect timing</p>
            </div>
            ...
            <div className="glass-card p-8 text-center">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-3 text-lg">Easy Sharing</h3>
              <p className="text-gray-700 dark:text-gray-200">Generate shareable links for your clips instantly</p>
            </div>
          </div>
        </div>
      </section>
