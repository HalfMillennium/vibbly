      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
            Create{" "}
            <span className="inline-block align-middle mx-1 sm:mx-2">🎬</span>{" "}
            stunning,
            <br />
            brand-ready{" "}
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              className="bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-4 sm:py-6 rounded-full text-sm sm:text-base w-full sm:w-auto"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="bg-[#222] text-white hover:bg-[#333] border-0 px-6 sm:px-8 py-4 sm:py-6 rounded-full text-sm sm:text-base w-full sm:w-auto mt-3 sm:mt-0"
            >
      ...
      <section className="pb-16 md:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center md:space-x-8 mb-12 gap-3 md:gap-0">
            <button className="text-primary font-medium border-b-2 border-primary pb-2 text-sm sm:text-base">
              Create visuals
            </button>
            <button className="text-gray-600 hover:text-gray-900 pb-2 text-sm sm:text-base">
              Train style models
            </button>
            <button className="text-gray-600 hover:text-gray-900 pb-2 text-sm sm:text-base">
              Refine creations
            ...
            <div className="p-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-4 p-3 sm:p-4">
                ...
                <div className="aspect-square bg-gray-100 rounded-md p-2 sm:p-3 flex items-center justify-center overflow-hidden">
                  <img
                    src={businessManSvg}
                    alt="Business person with umbrella"
