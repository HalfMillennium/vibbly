          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {isSignedIn ? (
                ...
                appearance={{
                  elements: {
                    ...
                    userButtonPopoverCard:
                      "bg-white dark:bg-[#16181d] border border-gray-200 dark:border-gray-700 shadow-lg",
                    userButtonPopoverHeader:
                      "bg-white dark:bg-[#16181d] border-b border-gray-200 dark:border-gray-700",
                    userButtonPopoverMain: "bg-white dark:bg-[#16181d]",
                    userButtonPopoverFooter:
                      "bg-white dark:bg-[#16181d] border-t border-gray-200 dark:border-gray-700",
                    userButtonPopoverActions: "bg-white dark:bg-[#16181d]",
              ...
              <SignInButton
                ...
                appearance={{
                  elements: {
                    modalContent: "bg-white dark:bg-[#16181d] rounded-t-md",
                    modalCloseButton:
                      "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200",
                    card: "bg-white dark:bg-[#16181d] border rounded-t-md border-gray-200 dark:border-gray-700",
                    cardBox: "bg-white dark:bg-[#16181d] rounded-t-md",
                    header:
                      "bg-white dark:bg-[#16181d] border-b border-gray-200 dark:border-gray-700",
                    headerTitle: "text-gray-900 dark:text-gray-100",
                    headerSubtitle: "text-gray-600 dark:text-gray-400",
                    main: "bg-white dark:bg-[#16181d]",
                    footer:
                      "bg-white dark:bg-[#16181d] border-t border-gray-200 dark:border-gray-700",
                    ...
                    socialButtonsBlockButton:
                      "border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 bg-white dark:bg-[#16181d]",
                    socialButtonsBlockButtonText:
                      "text-gray-700 dark:text-gray-200",
                    dividerLine: "bg-gray-200 dark:bg-gray-600",
                    dividerText: "text-gray-500 dark:text-gray-400",
                    formFieldInput:
                      "bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100",
